...
class PermissionRepository extends DbRepository
{
    ...
    /**
     * Get Json PermissionTree By Role
     * 
     * @param object $role
     * @return array
     */
    public function getJsonPermissionTreeByRole($role = null)
    {
    	$result = [];

    	if($role)
    	{
    		$assignedPermission = $role->permissions->pluck('id')->toArray();
	    	...
	    	foreach($permissions as $permission)
	    	{
	    		...
	    		if(in_array($permission->id, $assignedPermission))
	    		{
	    			$selected = true;
	    		}
    ...
    /**
     * Get Json PermissionTree
     * 
     * @return array
     */
    public function getJsonPermissionTree()
    {
    	$permissions 	= $this->model->getAll();
    	$result 		= [];
